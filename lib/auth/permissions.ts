...
const routePermissionRules: RoutePermissionRule[] = [
  ...
  { pattern: /^\/agenda$/, permissions: ["agenda_own_view", "agenda_view", "agenda_manage", "agenda_manage_status"] },
  { pattern: /^\/agendamentos$/, permissions: ["agenda_own_view", "agenda_view", "agenda_manage", "agenda_manage_status"] },
  { pattern: /^\/agendamentos\/[^/]+$/, permissions: ["agenda_own_view", "agenda_view", "agenda_manage", "agenda_manage_status"] },
  ...
  { pattern: /^\/custos-operacionais$/, permissions: ["settings_manage"] },
