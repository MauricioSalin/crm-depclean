...
test("conclui o atendimento com motorista opcional, ajudantes e observações", async ({ page }) => {
  ...
  const disposalQuantityInput = page.getByLabel("Quantidade (M³) *")
  await expect(disposalQuantityInput).toHaveAttribute("placeholder", "2,5")
  await disposalQuantityInput.fill("2,5")
