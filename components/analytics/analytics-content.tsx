      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
        {stats.map((stat, index) => (
          <Card
            ...
            className={`bg-card text-foreground p-4 transition-all duration-500 ease-out cursor-pointer ${
        ...
        <Card className="p-6">
          ...
          <div className="space-y-6">
            {[
              ...
              <div
                key={item.name}
                className="flex items-center justify-between p-3 rounded-lg border border-border hover:shadow-md transition-all duration-300" 
              >
