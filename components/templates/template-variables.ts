...
export const TEMPLATE_VARIABLE_GROUPS: TemplateVariableGroup[] = [
  ...
  },
  {
    ...
    variables: [
      ...
      { path: "contract.downPaymentsText", label: "Resumo das primeiras parcelas", kinds: ["contract"] },
      { path: "contract.installmentDueDatesText", label: "Texto dos vencimentos das parcelas", kinds: ["contract"] },
      ...
      { path: "contract.remainingInstallmentsText", label: "Resumo das parcelas subsequentes", kinds: ["contract"] },
