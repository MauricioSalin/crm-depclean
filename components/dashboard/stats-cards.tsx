...
export function StatsCards(period: DashboardPeriodProps = {}) {
  ...
  const revenuePeriodPicker = (
    <DropdownMenu open={isRevenuePeriodOpen} onOpenChange={setIsRevenuePeriodOpen}>
      ...
      <DropdownMenuContent align="start" className="w-[252px] p-2">
        ...
        >
          <SelectTrigger className="mb-2 w-full cursor-pointer data-[state=open]:bg-muted/70">
        ...
        <DropdownMenuRadioGroup value={globalValueMode} onValueChange={(value) => setGlobalValueMode(value as "general" | "contractual") }>
          <Tooltip delayDuration={1000}>
            ...
            <TooltipContent side="right" sideOffset={8} className="z-[230] max-w-52">
              Contratos vigentes, vencidos, renovados, serviços e extras.
            </TooltipContent>
          </Tooltip>
          <Tooltip delayDuration={1000}>
            <TooltipTrigger asChild>
  ...
  const stats = [
    ...
    {
      title: "Valor Global",
      value: formatCurrency(dashboardStats.globalValue ?? dashboardStats.currentContractsGlobalValue),
    ...
    },
    {
      ...
      value: dashboardStats.expiredContracts.toString(),
      icon: FileX2,
      href: "/contratos?validity=expired",
      bgColor: "bg-card",
      textColor: "text-foreground",
      delay: "180ms",
    },
