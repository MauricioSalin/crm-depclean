...
export default function FuncionariosPage() {
  ...
  const toggle = (
    <Tabs value={viewMode} onValueChange={(v) => setViewMode(v as "table" | "cards")}>
      <TabsList>
        <TabsTrigger value="table" aria-label="Visualizar funcionários em tabela"><List className="h-4 w-4" /></TabsTrigger>
        <TabsTrigger value="cards" aria-label="Visualizar funcionários em cartões"><LayoutGrid className="h-4 w-4" /></TabsTrigger>
      </TabsList>
    </Tabs>
  )
