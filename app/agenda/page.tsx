...
export default function AgendaPage() {
  ...
  return (
    <div className="flex min-h-dvh bg-background lg:h-screen lg:overflow-hidden lg:[@media(max-height:1199px)]:h-[calc(100dvh+140px)] lg:[@media(max-height:1199px)]:min-h-[calc(100dvh+140px)]">
