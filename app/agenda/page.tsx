...
export default function AgendaPage() {
  ...
  return (
    <div className="flex min-h-dvh bg-background lg:h-screen lg:overflow-hidden [@media(max-height:1199px)]:h-auto [@media(max-height:1199px)]:min-h-screen [@media(max-height:1199px)]:overflow-visible">
      <div className="hidden lg:block">
        <Sidebar />
      </div>

      <main className="flex min-h-0 flex-1 flex-col overflow-y-auto px-3 pb-4 md:px-4 lg:ml-60 lg:overflow-hidden lg:px-5 [@media(max-height:1199px)]:overflow-visible">
        <Header
          title="Agenda"
